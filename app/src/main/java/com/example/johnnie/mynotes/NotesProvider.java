...
/**
 * Created by Johnnie on 2016-02-24.
 */
public class NotesProvider extends ContentProvider {

    private static final String AUTHORITY = "com.example.johnnie.notesprovider";
    ...
    static {
        uriMather.addURI(AUTHORITY, BASE_PATH, NOTES);
//                addURI(String authority, String path, int code);
        uriMather.addURI(AUTHORITY, BASE_PATH + "/#", NOTES_ID);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (uriMather.match(uri) == NOTES_ID){
